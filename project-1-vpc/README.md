...
![Step 1: VPC Settings](NextWork-AWS-Networking-Projects/project-1-vpc/screenshots/vpc-settings.png)
...
![Step 2: Subnet Settings](NextWork-AWS-Networking-Projects/project-1-vpc/screenshots/subnet-settings.png)
...
![Step 3: Internet Gateway](NextWork-AWS-Networking-Projects/project-1-vpc/screenshots/internet-gateway.png)
...
## 📂 Project Files
- Documentation: [`steps.md`](NextWork-AWS-Networking-Projects/project-1-vpc/docs/steps.md.pdf)  
